...
class RestaurantsList extends Component {
  ...
  getRestaurantList = async () => {
    this.setState({isLoading: true, isAvailable: false})
    ...
    if (response.ok === true) {
      ...
      this.setState({isLoading: false, isAvailable: true})
    }
  }
  ...
  render() {
    ...
    return (
      <div className="popular-restaurant-container">
        <h1 className="popular-restaurant-title">Popular Restaurants</h1>
